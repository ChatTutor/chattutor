...
questions = [
    ...
    (
        "Is the paper ''Entanglement-enhanced testing of multiple quantum hypotheses' in the database?",
        BASIC,
    ),
...
for question, expected_answer in questions:
    ...
    if r != expected_answer:
        ...
        raise (
            Exception(rf"{question} return {r}, and {expected_answer} was expected!")
        )
