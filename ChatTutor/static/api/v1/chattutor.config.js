...
/**
 * RESPONSE_TYPE: Choose between
 *  - COURSE_RESTRICTED:
 *  - COURSE_FOCUSED:    
 */
const RESPONSE_TYPE = "COURSE_FOCUSED"
/**
 * --------------- TESTING CONFIGS ----------------
 ...
 * purposes (TEST_MODE = true)
 */
const BUILT_WITH = "JUPYTER-NOTEBOOK";
/**
 * SERVER_PORT that hoststhe chattutor server on
 * localhost (127.0.0.1) if TEST_MODE==true
 */
