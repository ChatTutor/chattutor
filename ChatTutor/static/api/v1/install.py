...
css_path = "./_build/html/_static/styles/chattutor.style.css"
js_path = "./_build/html/_static/scripts/chattutor.min.js" 
config_path = "./_build/html/_static/scripts/chattutor.config.js" 

shutil.copyfile("./chattutor_setup/chattutor.style.css", css_path)
shutil.copyfile("./chattutor_setup/chattutor.config.js", config_path)
shutil.copyfile("./chattutor_setup/chattutor.min.js", js_path)
